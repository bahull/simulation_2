...
class WizardFour extends Component {
   ...
   <div className='container-back1'>
      ...
      <h4 className='header-loan'> Loan Amount </h4>
        <input className="bars" onChange={ (e) => {this.props.updateLoanAmount (e.target.value)}}/> 
        <h4 className='header-mortgage'> Monthly Mortgage </h4>
        <input className="bars" onChange={ (e) => {this.props.updateMonthlyMortgage (e.target.value)}}/> 
