          ...
          <div className="innerContain">
            ...
            <div className="container">
              ...
              <button
                type="submit"
                className="login"
                onClick={() => login(this.props.username, this.props.password)}
              >
                Login
              </button>
              ...
              <button
                type="submit"
                className="signUp"
                onClick={() => signUp(this.props.username, this.props.password)}
              >
                Register
              </button>
            </div>
...
export default connect(mapStateToProps, { updatePassword, updateUsername })(
  Header
);
